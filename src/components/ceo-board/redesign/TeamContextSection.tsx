...
// No synthetic defaults — team context comes from real data or shows empty state
...
export function TeamContextSection({ data }: TeamContextSectionProps) {
  ...
  return (
    ...
    >
      ...
      {!ctx ? (
        <p className="text-sm text-gray-400 italic">No team context configured yet. Set up your company profile to see team details here.</p>
      ) : (
      ...
      {/* Map placeholder — will be replaced when geo data is available */}

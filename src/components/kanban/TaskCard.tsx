 ...
 * (`task.comms_audience_source`, migration 106) alongside the chips above.
 * Empty-state (renders nothing) when the field is absent — see its own
 * docstring for the migration-090-vs-106 `audience_source` field collision
 ...
 * migration 106, DISTINCT from `task.audience_source` (migration 090, which

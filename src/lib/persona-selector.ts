...
export function persistPersonaBundle(
  ...
  // U116 (E6-2 / ADD-2, migration 106) — the BUNDLE-ROOT comms-audience-prompt
  ...
  try {
    ...
    console.warn(`[persona-bundle] mirror-column update failed for task ${taskId} (pre-090/pre-106 DB?):`, (err as Error).message);
  }

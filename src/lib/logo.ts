 ...
 * 3. Generic "COMMAND CENTER" text placeholder (no image)
 */
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 60" fill="none">
  <text x="0" y="44" font-family="Arial, sans-serif" font-size="32" font-weight="bold" fill="#1e293b" letter-spacing="1">COMMAND CENTER</text>
</svg>
`)}`;

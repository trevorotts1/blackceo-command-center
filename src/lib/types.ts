 ...
 * extended by U115's migration 107). Rendered as a per-scope chip on the
...
export interface Task {
  ...
  // FIX-17 (Error 12 / Rule R12 — migration 114): the authoritative owner-kill
  ...
  // audience-prompt mirror columns (migration 108). Written by
  ...
  // the other. Additive + nullable — absent on a pre-108 row and on any task
